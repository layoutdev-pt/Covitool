  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Logo */}
          <Link to="/" className="flex items-center shrink-0 transition-all duration-500 relative z-[60]" onClick={handleNavigation}>
            <img 
              src="/logo.png"
              alt="Covitool Logo" 
          ...
          <nav className="hidden lg:flex items-center gap-10">
            <Link className={getLinkClasses("/")} to="/" onClick={handleNavigation}>Home</Link>
            <Link className={getLinkClasses("/marcas")} to="/marcas" onClick={handleNavigation}>Marcas</Link>
            <Link className={getLinkClasses("/sobre-nos")} to="/sobre-nos" onClick={handleNavigation}>Sobre Nós</Link>
            <Link className={getLinkClasses("/folhetos")} to="/folhetos" onClick={handleNavigation}>Folhetos</Link>
          </nav>
      ...
      >
        ...
        >
          <Link className={getLinkClasses("/", true)} to="/" onClick={handleNavigation}>Home</Link>
          <Link className={getLinkClasses("/marcas", true)} to="/marcas" onClick={handleNavigation}>Marcas</Link>
          <Link className={getLinkClasses("/sobre-nos", true)} to="/sobre-nos" onClick={handleNavigation}>Sobre Nós</Link>
          <Link className={getLinkClasses("/folhetos", true)} to="/folhetos" onClick={handleNavigation}>Folhetos</Link>
        </div>
