  ...
  return (
    <section className="bg-white w-full">
      <div className="max-w-7xl mx-auto px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-6 h-auto md:h-145">
          ...
          <div className="md:col-span-2 md:row-span-2 min-h-87.5 md:min-h-0 relative group overflow-hidden rounded-[40px] shadow-sm bg-white border border-gray-100">
            <img
            ...
            <div className="absolute inset-0 bg-linear-to-t from-[#003dc2]/70 via-[#003dc2]/25 to-transparent"></div>
          ...
          <div className="md:col-span-1 bg-[#f0f2f8] rounded-[40px] p-8 flex flex-col justify-center items-center text-center border border-gray-50 shadow-sm transition-all hover:shadow-md">
            ...
            <p className="text-gray-500 text-sm leading-relaxed max-w-40">
          ...
          <div className="md:col-span-1 min-h-55 md:min-h-0 relative overflow-hidden rounded-[40px] shadow-lg group">
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center p-8 text-center z-10">
              ...
              <p className="text-white/90 text-sm leading-relaxed max-w-40">
          ...
          {/* CORREÇÃO AQUI: Adicionado 'min-h-[220px] md:min-h-0' */}
          <div className="md:col-span-1 min-h-55 md:min-h-0 relative overflow-hidden rounded-[40px] shadow-sm group">
            <img
              className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
              src={IMG_STOCK}
              alt="Stock"
            ...
            <div className="absolute inset-x-0 bottom-0 h-[50%] backdrop-blur-xs [-webkit-mask-image:linear-gradient(to_top,black_30%,transparent_100%)] mask-[linear-gradient(to_top,black_30%,transparent_100%)] pointer-events-none"></div>
