      ...
      <div className="relative h-[85vh] md:h-[750px] w-full max-w-[1440px] mx-auto overflow-hidden rounded-[40px] shadow-2xl">
        ...
        <div className="relative h-full px-12 md:px-24 flex flex-col justify-center items-start">
          <h1 className="font-h1 text-white text-5xl md:text-7xl max-w-3xl mb-6 font-black leading-[1.1]">
            Peças e acessórios de <br/> <span className="text-[#B5D318]">Alta Qualidade</span>
          </h1>
          <p className="font-body-lg text-white/90 max-w-2xl mb-10 text-xl leading-relaxed font-light">
          ...
          <Link to="/sobre-nos#contacto" className="inline-flex items-center gap-3 bg-[#B5D318] hover:bg-[#a1bc12] text-[#153A81] px-8 py-4 rounded-full font-bold text-lg transition-all shadow-xl hover:-translate-y-1">
