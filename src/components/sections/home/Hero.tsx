  ...
  return (
    <section className="relative w-full px-4 pt-2 pb-16 bg-gray-50">
      ...
      <div className="relative h-[85vh] md:h-[750px] w-full max-w-[1440px] mx-auto overflow-hidden rounded-[40px] shadow-2xl">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-brand-blue/90 via-brand-blue/50 to-transparent"></div>
        ...
        <div className="relative h-full px-6 sm:px-12 md:px-16 lg:px-24 flex flex-col justify-center items-start">
          <h1 className="font-h1 text-white text-4xl sm:text-5xl md:text-6xl max-w-3xl mb-4 sm:mb-6 font-black leading-[1.15] sm:leading-[1.1]">
            Máquinas, ferramentas e acessórios industriais de <br />{" "}
            <span className="text-brand-lime">Alta Qualidade</span>
          </h1>
          <p className="font-body-lg text-white/90 max-w-2xl mb-8 sm:mb-10 text-lg sm:text-xl leading-relaxed font-light">
            Especialistas em equipamentos de alta performance para trabalhos que
            exigem o melhor em precisão, segurança e durabilidade.
          </p>

          <Link
            to="/sobre-nos#contacto"
            className="inline-flex items-center gap-2 sm:gap-3 bg-brand-lime hover:bg-[#a1bc12] text-brand-blue px-6 py-3 sm:px-8 sm:py-4 rounded-full font-bold text-base sm:text-lg transition-all shadow-xl hover:-translate-y-1"
          >
