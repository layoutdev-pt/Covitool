...
const passos = [
  {
    ...
    descricao:
      "Explore as marcas que comercializamos e os folhetos com as novidades no nosso site. Se preferir, ligue-nos diretamente para saber o que temos disponível e pedir aconselhamento.",
    icone: "manage_search",
  },
  {
    id: 2,
    ...
    descricao:
      "Após escolher o material, faça o seu pedido de forma simples por telefone. Pode optar por levantar as ferramentas na nossa loja física ou solicitar o envio por transportadora.",
  ...
  },
  {
    ...
    descricao:
      "Seja ao nosso balcão na Covilhã ou através da entrega na sua morada, garantimos que a sua encomenda chega até si com a maior brevidade possível para que o trabalho não pare.",
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="text-center mb-24">
          ...
          <p className="text-gray-500 max-w-2xl mx-auto mt-4 text-lg">
            Um processo simplificado para que receba as suas peças com total
