  ...
  return (
    <div className="flex flex-col gap-12 pb-12">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        <h2 className="text-2xl font-bold text-[#153A81] mb-6">
        ...
        <form onSubmit={handleMesSubmit} className="flex flex-col gap-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                required
                className="p-3 border rounded-xl outline-none focus:border-[#B5D318]"
              />
            </div>
            <div className="flex flex-col gap-2">
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              disabled={loading}
              className="bg-[#153A81] hover:bg-[#0d2657] text-[#B5D318] px-8 py-3 rounded-xl font-bold transition-all"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <form onSubmit={handleGridSubmit} className="flex flex-col gap-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex flex-col gap-3 p-4 bg-gray-50 rounded-xl border border-gray-200">
                ...
                <input
                  ...
                  className="p-3 border border-gray-300 rounded-xl outline-none focus:border-[#B5D318]"
                  placeholder="Nome da Marca (Opcional)"
                />

                {exibirLogo && (
                  <div className="flex flex-col gap-1 mt-2">
                    <label className="text-xs font-semibold text-[#153A81]">
            ...
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 flex flex-col gap-4">
              <h3 className="font-bold text-[#153A81]">
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`${editId ? "bg-blue-600 hover:bg-blue-700 text-white" : "bg-brand-lime hover:bg-[#a1bc12] text-[#153A81]"} px-8 py-3 rounded-xl font-bold transition-all shadow-md flex items-center gap-2`}
              >
      ...
      <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
        ...
        <div className="flex flex-wrap gap-4">
          {marcas.map((m) => (
            <div
              key={m.id}
              className="w-32 border p-4 rounded-xl flex flex-col items-center gap-2 text-center relative hover:border-[#B5D318] transition-colors bg-gray-50"
            >
              ...
              <img
                ...
                alt="logo"
              />
              <span className="font-bold text-xs text-[#153A81] truncate w-full mt-auto">
                {m.nome || "Sem nome"}
              </span>
            </div>
          ))}
