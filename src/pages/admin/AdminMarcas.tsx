        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <form onSubmit={handleGridSubmit} className="flex flex-col gap-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex gap-3">
                    <label className="text-[10px] font-bold text-gray-500 uppercase flex items-center gap-1 cursor-pointer">
                      <input type="radio" checked={!exibirLogo} onChange={() => setExibirLogo(false)} className="accent-[#B5D318]" />
                      Texto
                    </label>
                    <label className="text-[10px] font-bold text-gray-500 uppercase flex items-center gap-1 cursor-pointer">
                      <input type="radio" checked={exibirLogo} onChange={() => setExibirLogo(true)} className="accent-[#B5D318]" />
                      Imagem
                    </label>
                  </div>
                </div>
            ...
            <div className="bg-gray-50 p-6 rounded-xl border border-gray-200 flex flex-col gap-4">
              <h3 className="font-bold text-[#153A81]">Fundo do Cartão em Repouso</h3>
              ...
              <div className="flex gap-6">
                ...
                <label className="flex items-center gap-2 cursor-pointer font-medium">
                  <input type="radio" checked={tipoFundo === 'imagem'} onChange={() => setTipoFundo('imagem')} className="w-5 h-5 text-[#B5D318]" /> Usar Imagem do Card
                </label>
              </div>
            ...
            <div className="w-full max-w-[200px] bg-white rounded-3xl shadow-sm border border-gray-100 flex flex-col justify-center items-center hover:shadow-2xl transition-all duration-500 cursor-pointer group relative overflow-hidden h-32 hover:h-64">
              ...
              >
                ...
                {exibirLogo && previewLogoUrl ? (
                  ...
                  nome && (
                    <span className="font-black text-xl tracking-widest relative z-10 px-2 text-center w-full block drop-shadow-sm flex items-center justify-center h-full" style={{ color: corTexto }}>
                      {nome}
                    </span>
                  )
                )}
