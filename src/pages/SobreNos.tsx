...
export default function SobreNos() {
  ...
  return (
    <main className="flex flex-col gap-16 pb-12 bg-white">
      ...
      {/* Secção Hero Inicial (Tamanho Reduzido) */}
      <section className="bg-[#153A81] pt-36 pb-20 px-4 text-center text-white flex flex-col items-center justify-center relative overflow-hidden">
      ...
      {/* Secção de KPIs / Estatísticas (Textos a Verde/Amarelo) */}
      <section className="bg-[#153A81] text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8 text-center relative z-10">
          <div className="flex flex-col gap-2">
            ...
            <span className="text-sm font-bold tracking-widest uppercase text-[#B5D318]">Anos de Experiência</span>
          </div>
          <div className="flex flex-col gap-2">
            <span className="text-6xl font-black">500m²</span>
            <span className="text-sm font-bold tracking-widest uppercase text-[#B5D318]">Exposição e Stock</span>
          </div>
          <div className="flex flex-col gap-2">
            <span className="text-6xl font-black">+10k</span>
            <span className="text-sm font-bold tracking-widest uppercase text-[#B5D318]">Referências de Produtos</span>
          </div>
        </div>
      </section>

      {/* Secção de Instalações e Serviços (Cartões Aumentados) */}
      <section className="container mx-auto px-4 mt-4">
        <h2 className="text-3xl text-[#153A81] text-center mb-16 font-black tracking-tight">Instalações e Serviços</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          
          <div className="bg-white p-12 rounded-[40px] shadow-sm border border-gray-100 text-center hover:shadow-xl hover:border-[#B5D318] transition-all duration-300 group">
            <div className="relative flex items-center justify-center mb-8 w-20 h-20 mx-auto">
            ...
            <h3 className="text-[#153A81] text-2xl font-bold mb-4">Equipamento Industrial</h3>
          ...
          <div className="bg-white p-12 rounded-[40px] shadow-sm border border-gray-100 text-center hover:shadow-xl hover:border-[#B5D318] transition-all duration-300 group">
            ...
            <h3 className="text-[#153A81] text-2xl font-bold mb-4">Logística Avançada</h3>
            <p className="text-gray-500 text-base leading-relaxed">
          ...
          <div className="bg-white p-12 rounded-[40px] shadow-sm border border-gray-100 text-center hover:shadow-xl hover:border-[#B5D318] transition-all duration-300 group">
            ...
            <h3 className="text-[#153A81] text-2xl font-bold mb-4">Entrega Rápida</h3>
            <p className="text-gray-500 text-base leading-relaxed">
